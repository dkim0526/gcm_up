...
public class CcsClient {
    ...
    private String mApiKey = "AIzaSyCEO5zVwZjO55U2qrO5_hy9j-xM2nY9vWo";
    ...
    private CcsClient(String projectId, String apiKey, boolean debuggable) {
        this();
        mApiKey = "AIzaSyCEO5zVwZjO55U2qrO5_hy9j-xM2nY9vWo";
    ...
    public static void main(String[] args) {
        final String projectId = "1001521486531";
